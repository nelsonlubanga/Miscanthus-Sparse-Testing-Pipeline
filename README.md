...
R packages: `dplyr`, `tidyr`, `stringr`, `rrBLUP`, `adegenet`, `BGLR`,
`parallel`, `ggplot2`, `asreml`.
...
- `data/raw/` -- raw phenotype records for Aberystwyth and Braunschweig,
  pre-filtered to the 125-genotype panel used in this study
- `data/` -- other inputs and intermediate data (marker matrix, genomic
  relationship matrix, population-group assignments, sparse-testing design
  definitions)
